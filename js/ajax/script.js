// ajax
// jquery page2page - сайт
// запрос  к серверу без перезагрузки
// contentType
// emptpy 
// file UTF-8 
// data - данные, которые будут отправляться на сервер
// dataType - автоматически обычно

// Обработчик событий

// Перед отправкой на сервер
// Успешно выполнен запрос ыгсыуыы
// Error - неудачное выполнение запроса
// XHR 
// Обработка выполнения deffered
